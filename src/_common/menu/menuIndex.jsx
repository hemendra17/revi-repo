...
export default function Menu({
  ...
  const nonCollapsedLogoClass =
    isMobile || collapseLogo ? '' : 'non-collapse-logo'
  ...
  const icon = isMobile
    ? // mobile
      lightMode
      ? config.logoUrlWhite
      : config.logoUrlTangerine
    : // desktop
    lightMode
    ? onTop || !collapseLogo
      ? config.logoPrimUrlMainWhite
      : config.logoUrlMainWhite
    : onTop || !collapseLogo
    ? config.logoPrimUrlMainTangerine
    : config.logoUrlMainTangerine
